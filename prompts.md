...
99_reorder_prompts.py 로 구현해주세요
```
...
21_check_missing_values.py 로 구현해주세요
```
...
16_check_duplicate.py 로 구현해주세요
```
- 채운 등재번호 확인하기
```
@deid_clinicaldata.xlsx 의 B 컬럼이 잘 채워졌는지 확인해주세요

11_verify_updates.py 로 구현해주세요
```
...
06_fill_registration_number.py 로 구현해주세요
```
...
01_make_sheet_list.py 로 구현해주세요
```
